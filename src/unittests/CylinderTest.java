...
public class CylinderTest {
    ...
    public void findIntersection() {
        ...
        List<Intersectable.GeoPoint> result = test.findIntersection(new Ray(new Vector(-2,0,1),new Point3D(2,0,0)));
        assertEquals(result.get(0).point,new Point3D(1,0,0.50));
        assertEquals(result.get(1).point,new Point3D(0,0,1));
    }
}